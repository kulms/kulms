		  ...
		  <hr />
            <table class="kunews" align="center" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td><a href="#" class="jqModal">view simple2</a> ...                            
                              <div class="jqmWindow" id="dialog2"> <a href="#" class="jqmClose">Close</a>
                                <hr>
                                <em>READ ME 22222</em> -->
                                This is a "vanilla plain" jqModal window. Behavior and appeareance extend far beyond this.
                                The demonstrations on this page will show off a few possibilites. I recommend walking
                        ...
                        <tr>
                          <td>&nbsp;</td>
                          <td><p>This is an example Basic usage of the jQuery UI dialog.</p>
						<!--<button id="opener">read more...</button>--><a href='#' id="opener">read more</a>...
						</td>
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                          <td><p>This is an example Basic usage of the jQuery UI dialog.</p>
                          <!--<button id="opener2">read more...</button> --><a href='#' id="opener2">read more</a>...
                          </td> 
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
                        </tr>
